...
for(i in 1:11) {
  ...
  p_out <- p + geom_map(map = World_Map_Joined, aes(map_id = region, fill = Happiness_Score), 
           ...
           scale_fill_gradient2(low = "#0D47A1", high = "#FFEB3B", mid = "#BBDEFB", 
                                midpoint = 5, name = name, limits = c(2, 8)) + #Filling countries based on happiness score
...
```{r, image2, echo=FALSE}
#Path image
map2011 <- '/Users/millieziebland/Documents/Uni/Semester 2/PSY6422 Data Analysis and Visualisation/PSY6422 Project/Figures/plot_2011.png'

#Display image
knitr::include_graphics(map2011)
```
