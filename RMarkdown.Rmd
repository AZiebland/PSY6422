...
The choropleth map shows that North America, Oceania and Europe have had consistently high happiness ratings over the last 10 years. For example, it is difficult to notice the change in colour of Australia, suggesting little change in happiness ratings over the years. In contrast, there is a lot of inconsistency in scores for countries located in Africa and Asia, made visible by the clear changes in colour. 
...
## **Summary**
It would seem that money *can* buy happiness but only up to a certain point. The regression line shows a rapid initial increase before beginning to plateau, suggesting that money can make you happy up until a certain point. 

### **Limitations and Future Directions**
However, it is important to consider other factors which may also be contributing to the happiness scores such as corruption or infrastructure. The countries with the lowest happiness ratings are third world countries whilst the highest rated countries are first world countries and consequently, there might be many other factors contributing to the happiness scores. 